...
set(WEBRTC_GIT_REPO "$ENV{NTG_WEBRTC_BUILD_REPO}")
if (WEBRTC_GIT_REPO STREQUAL "")
    set(WEBRTC_GIT_REPO "pytgcalls/webrtc-build")
endif ()
set(WEBRTC_GIT https://github.com/${WEBRTC_GIT_REPO})
message(STATUS "WebRTC artifact repo: ${WEBRTC_GIT_REPO}")
