...
set(WEBRTC_GIT_DEFAULT https://github.com/pytgcalls/webrtc-build)
set(WEBRTC_GIT ${WEBRTC_GIT_DEFAULT} CACHE STRING "WebRTC release repository URL")
if (DEFINED ENV{NTGCALLS_WEBRTC_GIT} AND NOT "$ENV{NTGCALLS_WEBRTC_GIT}" STREQUAL "")
    set(WEBRTC_GIT "$ENV{NTGCALLS_WEBRTC_GIT}" CACHE STRING "WebRTC release repository URL" FORCE)
endif ()
...
if(NOT TARGET WebRTC::webrtc)
    message(STATUS "libwebrtc m${WEBRTC_REVISION} from ${WEBRTC_GIT}")
    if (WINDOWS)
