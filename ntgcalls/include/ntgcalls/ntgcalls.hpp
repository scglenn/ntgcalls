...
namespace ntgcalls {
    ...
    public:
        ...
        ASYNC_RETURN(void) sendExternalFrameNV12(int64_t chatId, StreamManager::Device device,
                                                const BYTES(bytes::binary) &yPlane, int yStride,
                                                const BYTES(bytes::binary) &uvPlane, int uvStride,
                                                wrtc::FrameData frameData);
